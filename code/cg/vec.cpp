const long double a90 = atan(1) * 2;
const long double a180 = a90 * 2, a270 = a90 * 3, a360 = a90 * 4;
const long double dlt[2][2] = {0, a180, a360, a180};
...
struct vec {
    ...
    long double angle() const { // counterclockwise, start from (1, 0)
